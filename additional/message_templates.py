...
set_group_success2 = '''
Теперь вы можете получать расписание с помощью клавиатуры бота под полем ввода сообщения или используя команду
/расписание
...
on_group_join_message = '''
Приветствую!
Отправьте команду /start или /help для запуска бота.
'''
